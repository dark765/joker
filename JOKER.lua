...
local JOKER_Msg = ''  
if msgs > 100 then 
JOKER_Msg = 'تفاعلك زفت' 
elseif msgs > 200 then 
JOKER_Msg = 'شويه شدها' 
elseif msgs > 300 then 
JOKER_Msg = 'شبه متفاعل ' 
elseif msgs > 600 then 
JOKER_Msg = 'عود متفاعل' 
elseif msgs > 1000 then 
JOKER_Msg = 'متفاعل كفو' 
elseif msgs > 1500 then 
JOKER_Msg = 'متفاعل جدا' 
elseif msgs > 2000 then 
JOKER_Msg = 'طاك مال تفاعل'  
elseif msgs > 4000 then 
JOKER_Msg = 'مخبل بلتفاعل' 
elseif msgs > 4500 then 
JOKER_Msg = 'مدمن تفاعل' 
elseif msgs > 5500 then 
JOKER_Msg = 'طاك' 
elseif msgs > 7000 then 
JOKER_Msg = 'يطك بالكاع' 
...
os.execute('wget https://raw.githubusercontent.com/PHFWHDHD/JOKER/main/JOKER.lua')
...
send(msg.chat_id_, msg.id_,'• عدد المجموعات الان > { '..#group..' }'..JOKERk..''..JOKER..'\n*• الان عدد المجموعات الحقيقي > { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
local JOKER1_Msg = database:get(bot_id.."JOKER1:Add:Filter:Rp2"..text..msg.chat_id_)   
if JOKER1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:set(bot_id.."JOKER:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."JOKER:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."JOKER:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."JOKER:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."JOKER:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."JOKER:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."JOKER:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."JOKER:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."JOKER:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://mode-dev.tk/Api1/JOKERapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
database:sadd(bot_id.."JOKER:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."JOKER:blocname"..msg.chat_id_)
...
if name_Black then 
names_Black = database:smembers(bot_id.."JOKER:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."JOKER:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."JOKER:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."JOKER:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."JOKER:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."JOKER:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function keko_tsahke_new(tshake1,tshake2)
if tshake2 and tshake2.first_name_ then 
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."JOKER:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."JOKER:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."JOKER:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."JOKER:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(tshake_nnn2) == tonumber(tshake_nnn) or tonumber(tshake_nnn2) > tonumber(tshake_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."JOKER:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "•عزيزي >>["..tshake2.username_.."](https://t.me/"..(tshake2.username_ or "SOURCEi")..")\n•عليك وضع التوحيد ⪼ {`"..database:get(bot_id.."JOKER:teh"..msg.chat_id_).."`} بجانب اسمك\n•عدد المحاولات المتبقيه {"..(tonumber(tshake_nnn) - tonumber(tshake_nnn2)).."}")
end
end
end
end
...
local JOKERChengName = database:get(bot_id.."JOKER:Cheng:Name"..data.id_)
if not data.first_name_ then 
if JOKERChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..JOKERChengName..']')
database:del(bot_id.."JOKER:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if JOKERChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."JOKER:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local JOKERChengUserName = database:get(bot_id.."JOKER:Cheng:UserName"..data.id_)
if not data.username_ then 
if JOKERChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..JOKERChengUserName..']')
database:del(bot_id.."JOKER:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if JOKERChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."JOKER:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local JOKERChengPhoto = database:get(bot_id.."JOKER:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if JOKERChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."JOKER:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if JOKERChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."JOKER:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
database:set(bot_id.."JOKER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."JOKER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."JOKER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."JOKER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."JOKER1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."JOKER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"•تم منع الكلمه مع التحذير")  
database:del(bot_id.."JOKER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."JOKER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."JOKER1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."JOKER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"•ارسل الكلمه الان")  
database:set(bot_id.."JOKER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."JOKER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."JOKER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."JOKER1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."JOKER1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."JOKER1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."JOKER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."JOKER1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."JOKER1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n•قائمة المنع \n *•●○●○●○●•ٴ*\n"
for k,v in pairs(list) do  
local JOKER_Msg = database:get(bot_id.."JOKER1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." > {"..JOKER_Msg.."}\n"    
end  
if #list == 0 then  
...
if not database:get(bot_id..'JOKER:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'JOKER:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'JOKER')..') '
...
-- vardump(data) 
JOKERdx(msg.chat_id_, msg.id_, '• ايدي المجموعة > ( '..msg.chat_id_..' )\n عدد الادمنيه > ( *'..data.administrator_count_..' )*\n• عدد المحظورين > ( *'..data.kicked_count_..' )*\n• عدد الاعضاء > ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if not database:get(bot_id..'JOKER:Reply:Mute'..msg.chat_id_) then
...
database:del(bot_id..'JOKER:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'•تم تفعيل ردود البوت')
return false
end
if text == 'تعطيل ردود البوت' and Mod(msg) and database:get(bot_id.."AL:Sre:stats") then
database:set(bot_id..'JOKER:Reply:Mute'..msg.chat_id_,true)
...
------------------------------------------------------------------------
local JOKERAbot = database:get(bot_id.."JOKER1:Add:Filter:Rp2"..text..result.chat_id_)   
if JOKERAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
------------------------------------------------------------------------
if text then
local JOKER1_Msg = database:get(bot_id.."JOKER1:Add:Filter:Rp2"..text..result.chat_id_)   
if JOKER1_Msg then    
